...
const ownersRouter = require("./apis/routes/ownersRouter.js");
const usersRouter = require("./apis/routes/usersRouter.js");
const productsRouter = require("./apis/routes/productsRouter.js");
const cartsRouter = require("./apis/routes/cartsRouter.js");
const paymentsRouter = require("./apis/routes/paymentsRouter.js");
const authRouter = require("./apis/routes/authRouter.js");
const categoriesRouter = require("./apis/routes/categoriesRouter.js");
const countsRouter = require("./apis/routes/countsRouter.js");
const ordersRouter = require("./apis/routes/ordersRouter.js");
const historyOrdersRouter = require("./apis/routes/historyOrderRouter.js");
const orderReportsRouter = require("./apis/routes/orderReportRouter.js");
const customersRouter = require("./apis/routes/customersRouter.js");

const db = require("./apis/config/mongoose-connection.js");
...
app.use((err, req, res, next) => {
  ...
  return res
    .status(500)
    .json({ error: errStatus, message: errMessage, errorStack: err.stack });
});
